...
3. Sistem membaca dalam **5 kotak crop internal** — NIK, Nama, Alamat, dan 2 kotak lain untuk RT/RW s.d. Pekerjaan — walau yang tampil ke pengguna cuma **2 kotak** (NIK & satu kotak besar "Nama s.d. Berlaku Hingga") supaya tetap gampang diposisikan. Kotak Nama dan kotak Alamat sengaja dipisah dan **tidak pernah menyentuh baris Jenis Kelamin/Gol. Darah** — baris itu di lapangan sering terbaca kacau (mis. "LAKHLAKI"), jadi solusinya bukan mendeteksinya, tapi memastikan kotak Alamat memang tidak pernah membaca sampai ke sana. Tiap kotak juga diberi mode pembacaan (OCR) yang paling sesuai isinya — misalnya kotak NIK dibatasi hanya boleh membaca angka, kotak Nama mematikan "koreksi otomatis ke kata baku Bahasa Indonesia" supaya nama orang tidak dipaksa jadi kata lain yang mirip.
